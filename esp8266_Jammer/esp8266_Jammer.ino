...
void drawInterface() {
  if(displayOn){
    ...
    for (int i = curSite * rowsPerSite - rowsPerSite; i < curSite * rowsPerSite; i++) {
      if (i == 0) display.drawString(3, i * fontSize, " >>  HOTSPOT SERVER " + wifiMode);
      else if (i == 1) display.drawString(3, i * fontSize, " >>  HOST " + scanMode);
      else if (i == 2) display.drawString(3, i * fontSize, " >>  " + attackMode + " JAMMING");
...
void setup() {
  ...
  display.drawString(0, 50, "Surendra K.");
  display.display();
